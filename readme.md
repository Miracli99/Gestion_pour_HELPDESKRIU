...
##### BUT : CRUD (Create Read Update Delete) complet sur la table "t_contenu"
...
### Constater l'affichage du contenu de la table "t_contenu"
...
* On réalise UNIQUEMENT (choix de OM de la 707) l'action READ du CRUD (Create Read Update Delete) sur la table "t_contenu".
