...
try:
    ...
    """
    strsql_contenus_afficher = """SELECT id_contenu, contenu FROM t_contenu ORDER BY id_contenu ASC"""
    curseur_mabd.execute(strsql_contenus_afficher)
    data_contenus = curseur_mabd.fetchall()
